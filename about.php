                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><?php echo $langa['About_Us'];?></li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="col-12 col-xl-8">
                    ...
                    <div class="about-us-content bg-white mb-30 p-30 box-shadow">
                        ...
                        <div class="section-heading">
                            <h5><?php echo $langa['About_Us'];?></h5>
                        </div>
                        <p><?php echo $langa['p1'];?></p>
                        <p><?php echo $langa['p2'];?></p>
                        <ul>
                            <li><i class="fa fa-check"></i> .<?php echo $langa['p3'];?></li>
                            <li><i class="fa fa-check"></i> .<?php echo $langa['p3'];?></li>
                            <li><i class="fa fa-check"></i> .<?php echo $langa['p3'];?></li>
                            <li><i class="fa fa-check"></i> .<?php echo $langa['p3'];?></li>
                        </ul>
