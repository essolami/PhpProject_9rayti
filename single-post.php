            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-xl-8">
                    <div class="post-details-content bg-white mb-30 p-30 box-shadow">
                        <div id="hamza" class="blog-thumb mb-30">
   <?php echo '<img   src="img/'.$image.'" alt="">';?>
                        ...
                        <div class="blog-content">
                            <div class="post-meta">
                                ...
                                <a href="archive.html"><?php echo $categorie ?></a>
                            </div>
                           <a href="submit-video.php?idArticle=<?php echo $idArticle ?>"> <i class="fa fa-cogs" style="font-size: 36px;position: absolute;"></i></a>
                            <h4 class="post-title" style="margin-left: 50px;"><?php echo $titre; ?></h4>
                            <!-- Post Meta -->
